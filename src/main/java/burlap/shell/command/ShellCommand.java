 ...
 * 1 indicates that an important external variable, such as the state of an {@link burlap.mdp.singleagent.environment.Environment} was changed.
...
public interface ShellCommand {
	 ...
	 * @return a return code of the command. -1 indicates a parsing error. 0 indicates standard completion. 1 indicates that an important external variable, such as the state of an {@link burlap.mdp.singleagent.environment.Environment} was changed.
	 */
