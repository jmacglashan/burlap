 ...
 * {@link #canEnumerateObservations()}, {@link #getAllPossibleObservations()}, {@link #getObservationProbability(State, State, burlap.oomdp.singleagent.GroundedAction)},
 * {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)}, and
 * {@link #sampleObservation(State, burlap.oomdp.singleagent.GroundedAction)}.
 * <p>
 * {@link #canEnumerateObservations()} indicates whether this object can enumerate all observations and therefore implements
 * the {@link #getAllPossibleObservations()} and {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)}
 ...
 * should be thrown.
 * <p>
 * ({@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)} specifies the
 ...
 * <p>
 * {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)} generates a list of all possible
 ...
 * <p>
 * {@link #sampleObservation(State, burlap.oomdp.singleagent.GroundedAction)} samples an observation
 ...
 * hidden state.
 * <p>
 * The {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)} and
 * {@link #sampleObservation(State, burlap.oomdp.singleagent.GroundedAction)} methods can be trivially
 * implemented by having them return the result of the super class methods
 * {@link #getObservationProbabilitiesByEnumeration(State, burlap.oomdp.singleagent.GroundedAction)}
 * and {@link #sampleObservationByEnumeration(State, burlap.oomdp.singleagent.GroundedAction)}, respectively,
 * provided that the {@link #getAllPossibleObservations()} method is implemented. However, these methods may be computationally
 * inefficient because they require enumerating all observations as returned by the {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)}
...
public abstract class ObservationFunction {
	 ...
	 * {@link #getObservationProbability(State, State, burlap.oomdp.singleagent.GroundedAction)}
	 * methods.
	...
	/**
	 * A superclass method for easily implementing the {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)} method
	 ...
	 * and assigning their probability according to the {@link #getObservationProbability(State, State, burlap.oomdp.singleagent.GroundedAction)}
	 ...
	 * for the {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)} method.
	 * @param state the true MDP state that generated the observations
	 * @param action the action that led to the MDP state and which generated the observations.
	 * @return the observation probability mass/density function represented by a {@link java.util.List} of {@link burlap.oomdp.singleagent.pomdp.ObservationFunction.ObservationProbability} objects.
	 */
	...
	/**
	 * A superclass method for easily implementing the {@link #sampleObservation(State, burlap.oomdp.singleagent.GroundedAction)} method that
	 * samples an observation by first getting all non-zero probability observations, as returned by the {@link #getObservationProbabilities(State, burlap.oomdp.singleagent.GroundedAction)}
	 ...
	 * inefficient; therefore, it may be better to directly implement the {@link #sampleObservation(State, burlap.oomdp.singleagent.GroundedAction)}
