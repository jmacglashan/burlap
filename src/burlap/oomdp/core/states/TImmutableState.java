 ...
 *
 */
public final class TImmutableState extends OOMDPState implements State {
	...
	private final List<TIntArrayList>							objectIndexByTrueClass;
	 ...
	 */
	public TImmutableState(State s){
	...
	public TImmutableState(List<ImmutableObjectInstance> objects, TObjectIntHashMap<String> objectClassMap) {
		...
		this.addObjectListToList(this.objectInstances, this.numObservableObjects, numberClasses, objectIndexByTrueClass, objectClassMap);
		this.objectIndexByTrueClass = objectIndexByTrueClass;//Collections.unmodifiableList();
		this.objectClassMap = objectClassMap;//Collections.unmodifiableMap();
		this.objectMap = objectMap;//Collections.unmodifiableMap();
		this.hashCode = 0;
	}
	
	public TImmutableState(List<ImmutableObjectInstance> objects, TObjectIntHashMap<String> objectClassMap, List<TIntArrayList> objectIndexByTrueClass, TObjectIntHashMap <String> objectMap, int hashCode) {
	 ...
	 */
	public TImmutableState copy(){
		return this;
	}

	public TImmutableState setHashCode(int code) {
		return new TImmutableState(this.objectInstances, this.objectClassMap, this.objectIndexByTrueClass, this.objectMap, code);
	}
	...
	@Override
	public final TImmutableState addObject(ObjectInstance object) {
		return this.addAllObjects(Arrays.asList(object));
	}
	
	@Override
	public final TImmutableState addAllObjects(Collection<ObjectInstance> objectsToAdd) {
		...
		return new TImmutableState(objects, this.objectClassMap);
	}
	
	public final TImmutableState removeObject(String objectName) {
	...
	public final TImmutableState removeObject(ObjectInstance object) {
		return this.removeObject(object.getName());
	}
	
	public final TImmutableState removeAllObjects(Collection<ObjectInstance> objectsToRemove) {
	...
	public final TImmutableState replaceObject(ObjectInstance objectToReplace, ObjectInstance newObject) {
		...
		return new TImmutableState(objects, this.objectClassMap, this.objectIndexByTrueClass, this.objectMap, 0);
	}
	
	public final TImmutableState replaceAllObjects(List<ObjectInstance> objectsToRemove, List<ObjectInstance> objectsToAdd) {
		List<ImmutableObjectInstance> objects = new ArrayList<ImmutableObjectInstance>(this.objectInstances);
	...
	public final TImmutableState replaceAllObjectsUnsafe(List<ObjectInstance> objectsToAdd) {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof TImmutableState)){
			return false;
		}
		
		TImmutableState so = (TImmutableState)other;
