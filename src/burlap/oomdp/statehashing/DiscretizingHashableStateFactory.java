 ...
 *
 */
public class DiscretizingHashableStateFactory implements HashableStateFactory {
	 ...
	 */
	public DiscretizingHashableStateFactory(){
	...
	public HashableState hashState(State s) {
		return new DiscretizedHashableState(s);
	}
	...
	/**
	 * The StateHashTuple that is generated by objects of the {@link DiscretizingHashableStateFactory} class.
	 * @author James MacGlashan
	 *
	 */
	public class DiscretizedHashableState extends HashableState.CachedHashableState {

		public DiscretizedHashableState(State s) {
			super(s);
		}
