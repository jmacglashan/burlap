 ...
 */
public class IDDiscHashableState extends IDSimpleHashableState {

	public DiscConfig config = new DiscConfig(1.);

	public IDDiscHashableState() {
	}

	public IDDiscHashableState(DiscConfig config) {
		this.config = config;
	}

	public IDDiscHashableState(State s, DiscConfig config) {
		super(s);
		this.config = config;
	}
