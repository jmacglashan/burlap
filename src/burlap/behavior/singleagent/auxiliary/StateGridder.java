 ...
 * can be generated using the {@link #gridInputState(State)} method. This method takes a source input
...
public class StateGridder {
	 ...
	 * of {@link State} objects returned. Similarly, if objects have attribute that do not have a specification set for them,
	 ...
	 * @return a {@link java.util.List} of {@link State} objects that define the grid.
	 */
