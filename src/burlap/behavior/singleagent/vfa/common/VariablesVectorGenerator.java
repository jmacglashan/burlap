...
/**
 * A {@link StateToFeatureVectorGenerator} that iterates through all state variables in a state
 ...
 */
public class VariablesVectorGenerator implements StateToFeatureVectorGenerator {

	protected List<Object> whiteList = null;

	public VariablesVectorGenerator addToWhiteList(Object variableKey){
		if(whiteList == null){
