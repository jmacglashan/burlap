...
public class CoCoQ implements SGBackupOperator {
	...
	public double performBackup(State s, String forAgent, Map<String, AgentType> agentDefinitions, AgentQSourceMap qSourceMap) {
		return performBackupOldCode(s, forAgent, agentDefinitions, qSourceMap);
		
	}
	
	public double performBackupNewCode(State s, String forAgent, Map<String, AgentType> agentDefinitions, AgentQSourceMap qSourceMap) {
		...
		double [] otherAgentStrat = MinMaxSolver.getColPlayersStrategy(minMaxPayout);
	...
	public double performBackupOldCode(State s, String forAgent, Map<String, AgentType> agentDefinitions, AgentQSourceMap qSourceMap){
		if(agentDefinitions.size() != 2){
			throw new RuntimeException("CoCoQ only defined for two agents.");
		}
