...
import burlap.behavior.stochasticgames.saconversion.MinDistValueFunctionInitialization;
import burlap.behavior.stochasticgames.saconversion.RTDPGreedyQPolicy;
...
public abstract class BestResponseToDistributionAgent extends SGAgent {
	...
	public BestResponseToDistributionAgent(SGDomain domain, HashableStateFactory hashFactory,
	...
	public Policy boundedRTDP(Domain saDomain, Domain ggDomain,
		...
		Policy p = new RTDPGreedyQPolicy((QFunction) planner);
