 ...
 * The required {@link #transitions(State, burlap.mdp.singleagent.GroundedAction)} method provides the full transition dynamics of
 ...
 * from the transition distribution defined with {@link #transitions(State, GroundedAction)}
...
public interface FullActionModel {
	 ...
	 */
	List<TransitionProbability> transitions(State s, GroundedAction groundedAction);
	...
	public static class FullActionModelHelper{
		 ...
		 * {@link burlap.mdp.singleagent.FullActionModel#transitions(State, GroundedAction)} method.
