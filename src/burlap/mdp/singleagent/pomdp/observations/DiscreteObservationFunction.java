 ...
 * {@link #probabilities(State, GroundedAction)} method. The former should return all possible observations; the
...
public interface DiscreteObservationFunction extends ObservationFunction {
	 ...
	 */
	List<ObservationProbability> probabilities(State state, GroundedAction action);
