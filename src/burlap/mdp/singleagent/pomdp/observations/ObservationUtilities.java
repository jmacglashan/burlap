...
public class ObservationUtilities {
	...
	/**
	 * A helper method for easily implementing the {@link DiscreteObservationFunction#probabilities(State, burlap.mdp.singleagent.GroundedAction)} method
	 ...
	 * and assigning their probability according to the {@link ObservationFunction#probability(State, State, burlap.mdp.singleagent.GroundedAction)}
	 ...
	 * for the {@link DiscreteObservationFunction#probabilities(State, burlap.mdp.singleagent.GroundedAction)} method.
	 ...
	 */
	public static List<ObservationProbability> probabilitiesByEnumeration(DiscreteObservationFunction of, State state, GroundedAction action){
	...
	/**
	 * A helper method for easily implementing the {@link ObservationFunction#sample(State, burlap.mdp.singleagent.GroundedAction)} method that
	 * samples an observation by first getting all non-zero probability observations, as returned by the {@link DiscreteObservationFunction#probabilities(State, burlap.mdp.singleagent.GroundedAction)}
	 ...
	 * inefficient; therefore, it may be better to directly implement the {@link ObservationFunction#sample(State, burlap.mdp.singleagent.GroundedAction)}
	 ...
	 */
	public static State sampleByEnumeration(DiscreteObservationFunction of, State state, GroundedAction action){
