...
import burlap.mdp.stochasticgames.oo.ObParamSGAgentAction;
 ...
 * ({@link burlap.mdp.stochasticgames.SGAgent}) in a stochastic game. This class is analogous
 * to the single-agent action definition class, {@link burlap.mdp.singleagent.Action}, except it does
 * not include the transition dynamic information which is instead provided by a {@link burlap.mdp.stochasticgames.JointActionModel}
 * that takes the simultaneous action selections of all agents in a game and determines the outcome.
 * <p>
 * A {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} is closely associated with an implementation of
 * the {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} class. An {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction}
 * differs from a {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} in that the {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction}
 ...
 * <p>
 * As noted previously, an {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} implementation
 * stores a set of parameter assignments that need to be provided to apply your parameterized {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}.
 * For custom parameterizations, you will need to subclass {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} to include data
 ...
 * {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} with its {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction#action} datamember
 * pointing to this  {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} and its {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction#actingAgent}
 * data member pointing to the actingAgent argument. The parameter assignments in the returned {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}
 ...
 * <p>
 * The {@link #getAllApplicableGroundedActions(State, String)} method should return a list of {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction}
 * instances, covering all possible parameterizations of this action for the acting agent in the given state. However,
 * the returned list should only include {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} instances that satisfy the
 * {@link #applicableInState(State, GroundedSGAgentAction)} method.
 * <p>
 * Overriding these two methods and having them return a custom {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} subclass
 * is all that is required to implement a parameterized {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} and by allowing you to
 * define your own subclass of {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction},
 * you can have any kind of {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}
 * parametrization that you'd like.
 * That said, a common form of {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} parameterization is an action that operates on OO-MDP
 * {@link burlap.mdp.core.oo.state.ObjectInstance} references in a state. If you would like to have a OO-MDP object parameterization,
...
public abstract class SGAgentAction {
	 ...
	 * @param gsa a {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} containing the agent name and any parameters of the action
	...
	/**
	 * Returns a {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} instance that
	 * is associated with this {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} for
	 ...
	 * @return the {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} associated with this {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}.
	 */
