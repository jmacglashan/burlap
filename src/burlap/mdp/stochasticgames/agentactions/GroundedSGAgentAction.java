...
/**
 * A {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} is a high-level implementation
 * of the {@link AbstractGroundedAction} that is closely associated with the {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}
 * definition of actions that can be taken by agents in a multi-agent stochastic game. The role of a {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction}
 * is to provide a reference to a corresponding {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}, a reference
 * to the name of the agent who is taking the action, and any other parameter assignment information that is necessary
 * for the agent to apply the action. The set of possible {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction} instances
 * specifying the set of possible parameter assignments an action can apply will be generated by the associated
 * {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} method
 * {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction#getAllApplicableGroundedActions(State, String)}.
 * See the {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} class documentation for more information on
 * defining parameterized {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction}s.
 * <p>
 ...
 * not parameterized, then you can simply use the {@link burlap.mdp.stochasticgames.agentactions.SimpleGroundedSGAgentAction}
 * implementation.
 *
 * <p>
 * If you plan on
 * making an {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} definition with OO-MDP object parameters, you can use the existing
 * {@link ObParamSGAgentAction}, which is associated with the {@link burlap.mdp.singleagent.GroundedAction}
 * subclass {@link ObParamSGAgentAction.GroundedObParamSGAgentAction}.
 *
...
public abstract class GroundedSGAgentAction implements AbstractGroundedAction {
	...
	/**
	 * Returns whether this action is applicable (satisfies the preconditions) in the given input {@link State}
	 * @param s the input state to check against
	 * @return true if this action is applicable (satisfies the preconditions) in the given input {@link State}; false otherwise
	 */
