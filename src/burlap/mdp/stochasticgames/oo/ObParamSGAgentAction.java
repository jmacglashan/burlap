...
/**
 *  If your {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} implementation is paramerterized to OO-MDP {@link burlap.mdp.core.oo.state.ObjectInstance}
 * references, you can subclass this {@link burlap.mdp.stochasticgames.agentactions.SGAgentAction} subclass to easily provide that functionality. The {@link burlap.mdp.stochasticgames.agentactions.GroundedSGAgentAction}
 ...
 * OO-MDP {@link burlap.mdp.core.oo.state.ObjectInstance} references.
 * <p>
 * The string array in the {@link #ObParamSGAgentAction(burlap.mdp.stochasticgames.SGDomain, String, String[])} constructor
 * specifies the valid OO-MDP state class names associated with a {@link burlap.mdp.core.oo.state.ObjectInstance}
